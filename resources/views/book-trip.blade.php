<x-guest-layout>
    <div class="flex sm:justify-center">
        <div class="w-full px-6 py-2 overflow-hidden bg-white shadow-md md:max-w-6xl sm:rounded-lg">
    ...
    @if(isset($trip))
    <div class="flex mt-10 sm:justify-center">
        <div class="w-full px-6 py-2 overflow-hidden bg-white shadow-md md:max-w-4xl sm:rounded-lg">
            @if(isset($trip->message))
                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    <p class="text-3xl font-bold text-center"><span class="font-extrabold">Info: </span> {{ $trip->message }}</p>
                </div>
            @else

            <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                <p class="text-3xl font-bold text-center"><span class="font-extrabold">Route: </span> {{ $trip->startLocation->place_name }} = TO = {{ $trip->endLocation->place_name }}</p>
            </div>

            <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                <p class="text-2xl font-bold text-center"><span class="font-extrabold">Fare Per Seat: </span> Tk. {{ $fare->fare_amt }}</p>
            </div>
                ...
                <div class="checkbox-group required">
                    <div class="mt-10">
                        <div class="relative overflow-x-auto text-center">
                            ...
                            <table class="w-full my-4 text-sm text-center text-gray-500 border border-collapse border-slate-400 dark:text-gray-400">
                                <tbody>
                                    @foreach($seatGroup as $group)
                                        <tr>
                                            <td scope="row" class="py-3 border w-52 border-slate-300">
                                            ...
                                            <td class="py-3 border w-52 border-slate-300">
